...
public class MyConfig {
	...
	public MyConfig(int id, String source_host, String user_name, String password, String list_file,
			String folder_download, String error_dir, String config_name, String extension_file, String file_name,
	...
	public String toString() {
		return "MyConfig [id=" + id + ", source_host=" + source_host + ", user_name=" + user_name + ", password="
				...
				+ error_dir + ", config_name=" + config_name + ", extension_file=" + extension_file + ", file_name="
